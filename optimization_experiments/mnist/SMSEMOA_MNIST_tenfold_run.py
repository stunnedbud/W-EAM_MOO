...
def evaluate_memory_config(
    ...
    return presum_avg, recsum_avg  # for a tenfold result we average the 10 measurements
...
problem = Problem(
    evaluate_memory_config, num_objectives=2, max_evaluations=1000, name="WEAM_MNIST"
)
dim = 4
popsize = 20
population = []
