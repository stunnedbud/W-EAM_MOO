...
smac_outdir = "ScenarioVResults"
# Historico de configuraciones intentadas
statsfilename = smac_outdir + "/SMSEMOA_bestrun_DIMEX.csv"
...
def evaluate_memory_config(
    config,
):  # (self, config: Configuration, seed: int) -> float:
...
ScenV = [0.3, 1.5, 0]
SMSEMOArun = [0.409042472, 1.950540673, 15]
presum, recsum = evaluate_memory_config(SMSEMOArun)
print("DONE")
print("pre sum, rec sum")
print(presum, recsum)
